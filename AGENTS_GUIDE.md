...
- Live Judge ledgers and hardening capability evidence live in the ignored private state root, not this public repository. The default is `.private-state/`; `AGENT_INSTRUCTIONS_PRIVATE_STATE_ROOT` may name another absolute location.
