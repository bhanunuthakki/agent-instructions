...
**Last refreshed: 2026-09-10 for Anthropic Claude Fable 5.1; 2026-09-09 for OpenAI GPT-6 Astra; 2026-09-02 for the other listed Anthropic models, OpenAI GPT-5.6 family, and Gemini 3.7 Flash; other rows retain their row-level verification dates. Next review: 2026-09-16.** Cross-provider blended cost-per-MTok, ordered cheapest → most expensive. Read this before answering model-cost questions; see `SKILL.md` for the formula and cheapest-at-parity procedure.
...
| `claude-fable-5-1` | Anthropic | 10.00 | 50.00 | 15.71 | 1M | Frontier orchestrator / demanding reasoning · long-horizon agentic work · judgment | 2026-09-10 | [Anthropic model overview](https://platform.claude.com/docs/en/models/fable-5-1/overview) |
| `gpt-6-astra` | OpenAI | 10.00 | 50.00 | 15.71 | 1.05M | Frontier orchestrator / hardest end-to-end reasoning · coding · research · computer use | 2026-09-09 | [OpenAI model page](https://developers.openai.com/api/docs/models/gpt-6-astra) |
...
## Frontier orchestration and Judge tier — 2026-09-10
...
Anthropic describes Fable 5.1 as its current model for demanding reasoning and long-horizon agentic work, at $10/$50 per MTok with a 1M context window. It supersedes Fable 5 in this frontier mapping; the replacement does not transfer any earlier purpose qualification. [Anthropic model overview](https://platform.claude.com/docs/en/models/fable-5-1/overview).

## GPT-6 Astra refresh — 2026-09-09
...
- **Qualification:** Astra ties the recorded Fable 5.1 token-price blend and costs 2.5× the recorded Sol rates. OpenAI reports lower task cost in some evaluations through fewer output tokens; that is a reason to measure complete-task quality, attempts, latency, and cost locally, not evidence of local parity or dominance. Astra remains `candidate_only` for persistent application routing and blocking Judge qualification. The evaluation-harness defaults exercise it as the frontier orchestrator and Judge but do not by themselves qualify a production route. [Provider claim](https://developers.openai.com/api/docs/guides/latest-model?model=gpt-6-astra).
