...
**Last refreshed: 2026-09-02 for the listed Anthropic models, OpenAI GPT-5.6 family, and Gemini 3.7 Flash; other rows retain their row-level verification dates. Next review: 2026-09-09.** Cross-provider blended cost-per-MTok, ordered cheapest → most expensive. Read this before answering model-cost questions; see `SKILL.md` for the formula and cheapest-at-parity procedure.
