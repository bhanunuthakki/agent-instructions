...
def render_contract(profile: str) -> str:
    return (
        ...
        "## Primitive authority\n\n"
        "- Catalog location: TODO (this contract section, a linked project document, or the "
        "established component catalog)\n"
        "- Executable source: TODO project-owned components, templates, tokens, or styles\n"
        "- Drift gate: TODO deterministic command\n"
        "- Safe auto-repair boundary: TODO mechanical repairs or none\n"
        "- Semantic distinctions: TODO action, annotation/status, responsive record, "
        "dismiss/close/delete, and state feedback\n\n"
        "## System and evidence\n\n"
