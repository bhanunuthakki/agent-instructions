...
**Last refreshed: 2026-08-25 across Anthropic, OpenAI, Google, and OpenRouter rows. Next review: 2026-08-31.** Cross-provider blended cost-per-MTok, ordered cheapest → most expensive. Read this before answering model-cost questions; see `SKILL.md` for the formula and cheapest-at-parity procedure.
...
| `gpt-5.6-luna` | OpenAI | 0.20 | 1.20 | 0.34 | 1.05M | Efficient / classify · extract · high-volume | 2026-08-25 | [developers.openai.com](https://developers.openai.com/api/docs/models/gpt-5.6-luna) |
...
| `gpt-5.6-terra` | OpenAI | 2.00 | 12.00 | 3.43 | 1.05M | Balanced workhorse / spec'd impl · prose · reasoning | 2026-08-25 | [developers.openai.com](https://developers.openai.com/api/docs/models/gpt-5.6-terra) |
